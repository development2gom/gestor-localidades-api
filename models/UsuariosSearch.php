...
/**
 * UsuariosSearch represents the model behind the search form about `app\models\ModUsuariosEntUsuarios`.
 */
class UsuariosSearch extends ModUsuariosEntUsuarios
{
    ...
    {
        $query = ModUsuariosEntUsuarios::find()->leftJoin("auth_item", "auth_item.name= mod_usuarios_ent_usuarios.txt_auth_item")
